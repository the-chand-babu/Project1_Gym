...
export default function About() {
  return (
    ...
    <div className={Styles.AboutUs}>
     ...
     <iframe width="360" height="515" src="https://www.youtube.com/embed/X_9VoqR5ojM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
    </div>
...
<ul className={Styles.listContainer}>
  <li><strong className={Styles.strong} >Consultation with expert</strong>
  ...
  <li><strong className={Styles.strong}> workout faculitis</strong>
  <p>Plus Fitness franchisee Jacob Awad first started his journey with the brand in 2013 after purchasing Plus Fitness Seven Hills from a previous owner. In 2017 Jacob then went on to purchase his second location, Plus Fitness Northmead.</p>
  </li>
</ul>
</div>
...
<iframe width="360" height="515" src="https://www.youtube.com/embed/Y5RtQ4cawVk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>
